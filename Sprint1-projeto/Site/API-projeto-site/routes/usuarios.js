...
router.post('/autenticar', function(req, res, next) {
    ...
    var login_backend = req.body.nome; // depois de .body, use o nome (name) do campo em seu formulário de login
    var senha = req.body.senha; // depois de .body, use o nome (name) do campo em seu formulário de login	

    let instrucaoSql = `select * from cadastro where (nomeUsuario='${login_backend}' or emailUsuario='${login_backend}')  and senha='${senha}'`;
